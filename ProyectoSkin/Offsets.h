...
const DWORD dwEntityList = 0x4DFFEF4;
const DWORD dwForceAttack = 0x322DCFC;
const DWORD dwForceAttack2 = 0x322DD08;
const DWORD dwForceBackward = 0x322DD38;
const DWORD dwForceForward = 0x322DD2C;
const DWORD dwForceJump = 0x52BBC7C;
const DWORD dwForceLeft = 0x322DD44;
const DWORD dwForceRight = 0x322DD50;
const DWORD dwGameDir = 0x63AD80;
const DWORD dwGameRulesProxy = 0x532F4AC;
const DWORD dwGetAllClasses = 0xE0BFDC;
const DWORD dwGlobalVars = 0x59EE60;
const DWORD dwGlowObjectManager = 0x535A9C8;
const DWORD dwInput = 0x525D4C8;
const DWORD dwInterfaceLinkList = 0x99BC84;
const DWORD dwLocalPlayer = 0xDEA964;
const DWORD dwMouseEnable = 0x5239128;
const DWORD dwMouseEnablePtr = 0x52390F8;
const DWORD dwPlayerResource = 0x322C0A0;
const DWORD dwRadarBase = 0x52369CC;
const DWORD dwSensitivity = 0xDEEB80;
const DWORD dwSensitivityPtr = 0xDEEB80;
const DWORD dwSetClanTag = 0x8DA80;
const DWORD dwViewMatrix = 0x4DF0D24;
const DWORD dwWeaponTable = 0x525E5A4;
const DWORD dwWeaponTableIndex = 0x326C;
const DWORD dwYawPtr = 0xDEE910;
const DWORD dwZoomSensitivityRatioPtr = 0xDF4380;
const DWORD dwbSendPackets = 0xDD2B2;
const DWORD dwppDirect3DDevice9 = 0xA62C0;
const DWORD find_hud_element = 0x56DAFBD0;
const DWORD force_update_spectator_glow = 0x3D91CA;
const DWORD interface_engine_cvar = 0x3FA9C;
const DWORD is_c4_owner = 0x3E69E0;
...
const DWORD m_pitchClassPtr = 0x5239020;
const DWORD m_yawClassPtr = 0xDEE910;
const DWORD model_ambient_min = 0x5A1194;
const DWORD set_abs_angles = 0x1E72D0;
const DWORD set_abs_origin = 0x1E7110;
//offsets acutalizados en https://github.com/frk1/hazedumper/blob/master/csgo.hpp
